source("utils.R")
data <- read.csv2("./data/mudelse1.8.csv", sep = "\t", header = FALSE)
...
postscript("./../informe/Kap3/Fig_Cap3/example_delta.eps")

plot.ts(delta_n, ylab = expression(Delta[n]), xlab = expression(n))
dev.off()
